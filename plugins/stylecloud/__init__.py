"""Cover-Schlagwortwolke — Plugin-Adapter (Qt).

Dünner UI-Einstieg: Domänenlogik in ``tools.stylecloud``, Dialog in
``ui_qt.dialogs.stylecloud_dialog``. Basiert auf
...
def run(studio: Optional[Any] = None, **kwargs) -> None:
    ...
    open_stylecloud_qt(studio, parent)
