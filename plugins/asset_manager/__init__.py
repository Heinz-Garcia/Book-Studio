"""Asset Manager — Plugin-Adapter (Qt)."""
...
def run(studio: Optional[Any] = None, **kwargs) -> None:
    from ui_qt.dialogs.asset_manager_dialog import open_asset_manager_qt

    parent = kwargs.get("parent") or getattr(studio, "root", None)
    open_asset_manager_qt(studio, parent)


def is_available() -> bool:
    return tool_exists(_REPO_ROOT, "ui_qt", "dialogs", "asset_manager_dialog.py")
