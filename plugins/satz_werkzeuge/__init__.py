...
def run(studio: Optional[Any] = None, **kwargs) -> None:
    from ui_qt.dialogs.satz_werkzeuge_dialog import open_satz_werkzeuge_qt

    parent = kwargs.get("parent") or getattr(studio, "root", None)
    open_satz_werkzeuge_qt(studio, parent)


def is_available() -> bool:
    return tool_exists(_REPO_ROOT, "ui_qt", "dialogs", "satz_werkzeuge_dialog.py")
